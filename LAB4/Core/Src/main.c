...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// Redirect printf to UART terminal
...
//task2
  ...
  //         countB++;
  //         countC++;
  //         // ORANGE LED 500 ms (1 Hz frequency)
  //         if (countA >= 500) 
  //         {
  ...
  //         // RED LED 200 ms (2.5 Hz frequency)
  //         if (countB >= 200) 
  //         {
  ...
  //         // BLUE LED 100 ms (5 Hz frequency)
  //         if (countC >= 100) 
  //         {
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
        ...
        htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
    {
        ...
        {
            period_ticks =
                (htim->Instance->ARR + 1U - last_capture)
                + current_capture;
        }
        ...
        if (period_ticks != 0)
        {
            frequency_hz = TIM3_TICK_HZ / period_ticks;
        }
    }
}
/* USER CODE END 0 */
...
int main(void)
{
  ...
  //   HAL_TIM_Base_Start(&htim2); //starts the timer
